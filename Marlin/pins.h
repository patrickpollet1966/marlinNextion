...
#if defined(REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER) && defined(ULTRA_LCD) && defined(NEWPANEL)
    #define BEEPER -1
    #define LCD_PINS_RS     9 // CS chip select /SS chip slave select
    #define BTN_EN1 16
    #define BTN_EN2 17
    #define BTN_ENC 18 // the click
    #define SDSS    26 // 8 pour la sd de l'afficheur, 26 pour la sd de la carte

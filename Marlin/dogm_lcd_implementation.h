...
#define BUTTONS_MOVE (buttons&EN_C | buttons&EN_A | buttons&EN_B)
#endif
...
//U8GLIB_ST7920_128X64_RRD u8g(0);  // version d'origine
U8GLIB_ST7920_128X64_4X u8g(LCD_PINS_RS); // version modifié pour avoir le HW SPI
